...
public class HolSpringSecApplication {
    ...
    @Bean // le garder en mémoire => nous allons pouvoir l'injecter à chaque
	  // fois ( la meme instance)
    protected PasswordEncoder passwordEncoder() {
	return new BCryptPasswordEncoder();
    }

    @EnableWebSecurity
    @EnableGlobalMethodSecurity(prePostEnabled = true, securedEnabled = true) // pour
									      // @Secured("")
